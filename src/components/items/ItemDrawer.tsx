          ...
          <>
            ...
            <div className="flex flex-col gap-6 px-4">
              {isEditing ? (
                ...
                <ItemDrawerView item={item} isPro={isPro} onUpgradeClick={handleUpgradeClick} />
              )}
            ...
            {isEditing && (
              <>
                ...
                <SheetFooter className="flex-row items-center justify-end gap-2">
                  ...
                  <Button size="sm" onClick={actions.handleSave} disabled={actions.saving || !editForm.title.trim()}>
